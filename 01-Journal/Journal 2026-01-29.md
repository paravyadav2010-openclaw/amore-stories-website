...
> 
> ### 🎯 Priorities
> 1. [x] fixing the bathroom fan
> 2. [ ] Be focused and productive on Office tasks
> 3. [ ] Follow the system 
> 
> ### 💭 Mood & Plan
...
> 2. a good health
> 3. all AI information and overall YouTube educational content
> 
> ### 💭 Review
> ````dataviewjs
...
> ````
> **Mood:** controlled 
> **Highlight:** Setting up the Claude bot on the computer and having it work through WhatsApp. 
> **Challenge:** Setting up the Claude bot, as it was a process never done before. 
> **Learning:** How to set up the Claude bot. 
> **Wins:** Successfully setting up the Claude bot. 
> 
> ### 🔮 Tomorrow
> *One thing to focus on:*
>
> Focus on fixing the fan and doing office work, avoiding touching any code.
>
> **📝 Notes:**
> 
